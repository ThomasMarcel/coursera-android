...
public class BookmarksActivity extends Activity {
	...
	private void startGoToDangerousActivity() {
		...
		//Intent dangerousIntent = new Intent("course.labs.permissions.DANGEROUS_ACTIVITY");
		//Intent chooserIntent = Intent.createChooser(dangerousIntent, "Pick a dangerous App");
		//startActivity(chooserIntent);
		Intent dangerousIntent = new Intent(getApplicationContext(), GoToDangerousActivity.class);
